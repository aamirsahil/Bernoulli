...
d3.select("#myRange").on("input", () => {
        ...
        if(length == (sliderRange[0])){
            ...
            setText(0);
            setMarker(0);
            plotFluidPoints.style("opacity", setOpacity(length,0,1) + "%");
        }
...
function setMarker(i){
        switch(i){
                case 0:
                        d3.select("#marker2").style("fill", greyUnCel);
                        d3.select("#marker3").style("fill", greyUnCel);
                        d3.select("#marker4").style("fill", greyUnCel);
                        d3.select("#marker5").style("fill", greyUnCel);
                    break;
                case 1:
                        d3.select("#marker2").style("fill", blueSel);
                        d3.select("#marker3").style("fill", greyUnCel);
                        d3.select("#marker4").style("fill", greyUnCel);
                        d3.select("#marker5").style("fill", greyUnCel);
                    break;
                case 2:
                        d3.select("#marker2").style("fill", blueSel);
                        d3.select("#marker3").style("fill", blueSel);
                        d3.select("#marker4").style("fill", greyUnCel);
                        d3.select("#marker5").style("fill", greyUnCel);
                    break;
            case 3:
                        d3.select("#marker2").style("fill", blueSel);
                        d3.select("#marker3").style("fill", blueSel);
                        d3.select("#marker4").style("fill", blueSel);
                        d3.select("#marker5").style("fill", greyUnCel);
                    break;
            case 4:
                        d3.select("#marker2").style("fill", blueSel);
                        d3.select("#marker3").style("fill", blueSel);
                        d3.select("#marker4").style("fill", blueSel);
                        d3.select("#marker5").style("fill", blueSel);
            } 
}
...
function setText(i){
        switch(i){
            case 0:
                d3.select("#point01").style("visibility", "visible");
                d3.select("#point02").style("visibility", "hidden");
                d3.select("#point03").style("visibility", "hidden");
                d3.select("#point04").style("visibility", "hidden");
                break;
            case 1:
                d3.select("#point01").style("visibility", "visible");
                d3.select("#point02").style("visibility", "visible");
                d3.select("#point03").style("visibility", "hidden");
                d3.select("#point04").style("visibility", "hidden");
                break;
            case 2:
                d3.select("#point01").style("visibility", "visible");
                d3.select("#point02").style("visibility", "visible");
                d3.select("#point03").style("visibility", "visible");
                d3.select("#point04").style("visibility", "hidden");
                break;
        case 3:
                d3.select("#point01").style("visibility", "visible");
                d3.select("#point02").style("visibility", "visible");
                d3.select("#point03").style("visibility", "visible");
                d3.select("#point04").style("visibility", "visible");
                break;
        case 4:
                d3.select("#point01").style("visibility", "hidden");
                d3.select("#point02").style("visibility", "hidden");
                d3.select("#point03").style("visibility", "hidden");
                d3.select("#point04").style("visibility", "hidden"); 
        }
