...
function setDataPointer(){
    ...
    dataPointer2.attr("cx",widthScale(dataVel.slice(0,totalNum)[Math.min(index + sectionWidthIndex, totalNum - 1)].x) - 3)
            .attr("cy", heightScale(dataVel.slice(0,totalNum)[Math.min(index + sectionWidthIndex, totalNum - 1)].y));
}
function setDataLine(){
    ...
    dataLine2.data([{
            ...
            y2: dataVel.slice(0,totalNum)[Math.min(index + sectionWidthIndex, totalNum - 1)].y
            }])
